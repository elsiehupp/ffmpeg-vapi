...
***********************************************************/
int ff_id3v2_match (uint8[] buf, string magic);
...
***********************************************************/
int ff_id3v2_tag_len (uint8[] buf);
...
***********************************************************/
void ff_id3v2_read_dict (AVIOContext *pb, AVDictionary **metadata, string magic, ID3v2ExtraMeta **extra_meta);
...
***********************************************************/
void ff_id3v2_read (AVFormatContext *s, string magic, ID3v2ExtraMeta **extra_meta,
...
***********************************************************/
int ff_id3v2_write_apic (AVFormatContext *s, ID3v2EncContext *id3, AVPacket *packet);
...
If in doubt, use ID3v2_DEFAULT_MAGIC.
***********************************************************/
int ff_id3v2_write_simple (AVFormatContext *s, int id3v2_version, string magic);
