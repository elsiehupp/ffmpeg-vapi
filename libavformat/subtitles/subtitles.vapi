...
system.
***********************************************************/
int ff_subtitles_queue_read_packet (FFDemuxSubtitlesQueue *q, AVPacket *packet);
...
***********************************************************/
static int ff_subtitles_next_line (string ptr);
...
***********************************************************/
size_t ff_subtitles_read_line (FFTextReader *tr, string buf, size_t size);
