...
[CCode (cname="ff_dash_muxer", cheader="")]
public class DashOutputMuxer : AVOutputFormat {
    ...
    [CCode (cname="dash_write_header", cheader="")]
    public override int write_header (
        AVFormatContext format_context
    );
    [CCode (cname="dash_write_packet", cheader="")]
    public override int write_packet (
        void *opaque,
        uint8[] buffer,
        int buf_size
    );
    [CCode (cname="dash_write_trailer", cheader="")]
    public override int write_trailer (
        AVFormatContext format_context
    );
    [CCode (cname="dash_free", cheader="")]
    public override void deinit (
        AVFormatContext format_context
    );
    [CCode (cname="dash_check_bitstream", cheader="")]
