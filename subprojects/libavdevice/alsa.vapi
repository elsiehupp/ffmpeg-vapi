...
public define DEFAULT_CODEC_ID; // AV_NE (LibAVCodec.CodecID.PCM_S16BE, LibAVCodec.CodecID.PCM_S16LE)
...
public class AlsaData {
    ...
    ***********************************************************/
    ...
    public ReorderFuncDelegate reorder_func;
...
@param codec_id in: requested LibAVCodec.CodecID or LibAVCodec.CodecID.NONE;
                out: actually selected LibAVCodec.CodecID, changed only if
                LibAVCodec.CodecID.NONE was requested
