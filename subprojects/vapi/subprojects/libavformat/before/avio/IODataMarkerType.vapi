...
***********************************************************/
[CCode (cname="enum AVIODataMarkerType",cheader_filename="subprojects/ffmpeg/libavformat/avio.h")]
public enum LibAVFormat.IODataMarkerType {
    /***********************************************************
    ...
    ***********************************************************/
    ...
    LibAVFormat.IODataMarkerType.HEADER, followed by any LibAVFormat.IODataMarkerType.SYNC_POINT,
    ...
    ***********************************************************/
    ...
    /***********************************************************
    @brief A point in the output bytestream where the underlying LibAVFormat.IOContext might
