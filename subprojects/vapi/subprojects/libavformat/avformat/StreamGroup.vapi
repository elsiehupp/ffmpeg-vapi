...
public class LibAVFormat.StreamGroup {
    ...
    ***********************************************************/
    //  union {
        [CCode (cname="iamf_audio_element")]
        public LibAVFormat.IAMFAudioElement? iamf_audio_element;

        [CCode (cname="iamf_mix_presentation")]
        public LibAVFormat.IAMFMixPresentation? iamf_mix_presentation;

        [CCode (cname="tile_grid")]
        public LibAVFormat.StreamGroupTileGrid? tile_grid;

        [CCode (cname="lcevc")]
        public LibAVFormat.StreamGroupLCEVC? lcevc;
    //  } params;
    ...
    ***********************************************************/
    ...
    @param stream_group LibAVFormat.StreamGroup belonging to a media file.
    @param stream  LibAVFormat.Stream in the media file to add to the group.
