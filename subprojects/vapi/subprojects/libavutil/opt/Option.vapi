...
The LibAVUtil.Option field of the Class must be set to a null-terminated static array
...
public class LibAVUtil.Option {
    ...
    ***********************************************************/
    ...
    public LibAVUtil.Option av_opt_find (
        void *obj,
        string name,
        string unit,
        int opt_flags,
    ...
    ***********************************************************/
    ...
    public LibAVUtil.Option av_opt_find2 (
        void *obj,
        string name,
        string unit,
        int opt_flags,
    ...
    ***********************************************************/
    ...
    public LibAVUtil.Option av_opt_next (
        void *obj,
        LibAVUtil.Option prev
    );
    ...
    ***********************************************************/
    ...
    public int av_opt_get_q (
        ...
        string name,
        int search_flags,
        out LibAVUtil. Rational out_val
    );
    ...
    ***********************************************************/
    ...
    @param obj Class object to check LibAVUtil.Option on
    ...
    ***********************************************************/
    ...
    @param void_context an LibAVUtil.Option-enabled struct (its first member must be a pointer to Class)
    ***********************************************************/
