...
public class AudioFifo {
    ...
    ***********************************************************/
    [CCode (cname="av_audio_fifo_free",cheader_filename="subprojects/ffmpeg/libavutil/audio_fifo.h")]
    ...
    ***********************************************************/
    ...
    [CCode (cname="av_audio_fifo_realloc",cheader_filename="subprojects/ffmpeg/libavutil/audio_fifo.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_audio_fifo_write",cheader_filename="subprojects/ffmpeg/libavutil/audio_fifo.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_audio_fifo_peek",cheader_filename="subprojects/ffmpeg/libavutil/audio_fifo.h")]
    ...
    @return number of samples actually peek, or negative LibAVUtil.ErrorCode code
        ...
        nb_samples if av_audio_fifo_size is less than nb_samples.
    ***********************************************************/
    [CCode (cname="av_audio_fifo_peek_at",cheader_filename="subprojects/ffmpeg/libavutil/audio_fifo.h")]
    ...
    @return number of samples actually read, or negative LibAVUtil.ErrorCode code
        ...
        nb_samples if av_audio_fifo_size is less than nb_samples.
    ***********************************************************/
    [CCode (cname="av_audio_fifo_read",cheader_filename="subprojects/ffmpeg/libavutil/audio_fifo.h")]
    ...
    @return 0 if OK, or negative LibAVUtil.ErrorCode code on failure
    ***********************************************************/
    [CCode (cname="av_audio_fifo_drain",cheader_filename="subprojects/ffmpeg/libavutil/audio_fifo.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_audio_fifo_reset",cheader_filename="subprojects/ffmpeg/libavutil/audio_fifo.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_audio_fifo_size",cheader_filename="subprojects/ffmpeg/libavutil/audio_fifo.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_audio_fifo_space",cheader_filename="subprojects/ffmpeg/libavutil/audio_fifo.h")]
