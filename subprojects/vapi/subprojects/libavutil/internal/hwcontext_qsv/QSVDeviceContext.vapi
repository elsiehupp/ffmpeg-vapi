...
/***********************************************************
@file An API-specific header for LibAVUtil.HardwareDeviceType.QSV.
...
***********************************************************/
[CCode (cname="struct AVQSVDeviceContext",cheader_filename="subprojects/ffmpeg/libavutil/hwcontext_qsv.h")]
