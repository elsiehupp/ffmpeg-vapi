...
***********************************************************/
[CCode (cname="avutil_version",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
...
***********************************************************/
[CCode (cname="av_version_info",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
public string av_version_info ();

/***********************************************************
@brief Return the libavutil build-time configuration.
***********************************************************/
[CCode (cname="avutil_configuration",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
public string avutil_configuration ();

/***********************************************************
@brief Return the libavutil license.
***********************************************************/
[CCode (cname="avutil_license",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
...
[CCode (cname="FF_LAMBDA_SHIFT",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
public const int FF_LAMBDA_SHIFT;

[CCode (cname="FF_LAMBDA_SCALE",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
public const int FF_LAMBDA_SCALE;

/***********************************************************
@brief Factor to convert from H.263 QP to lambda
***********************************************************/
[CCode (cname="FF_QP2LAMBDA",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
public const int FF_QP2LAMBDA;

[CCode (cname="FF_LAMBDA_MAX",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
public const int FF_LAMBDA_MAX;

[CCode (cname="FF_QUALITY_SCALE",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
...
namespace TimeStamp {
    ...
    ***********************************************************/
    ...
    [CCode (cname="AV_NOPTS_VALUE",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
    ...
    ***********************************************************/
    ...
    [CCode (cname="AV_TIME_BASE",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
    public const int AV_TIME_BASE;

    /***********************************************************
    @brief Internal time base represented as fractional value
    ***********************************************************/
    [CCode (cname="AV_TIME_BASE_Q",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
    public const LibAVUtil. Rational AV_TIME_BASE_Q;
}
...
***********************************************************/
[CCode (cname="av_x_if_null",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
...
***********************************************************/
[CCode (cname="av_int_list_length_for_size",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
...
@return length of the list, in elements, not counting the terminator
***********************************************************/
[CCode (cname="av_int_list_length",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
...
***********************************************************/
[CCode (cname="av_fopen_utf8",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
...
***********************************************************/
[CCode (cname="av_get_time_base_q",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
public LibAVUtil. Rational av_get_time_base_q ();

[CCode (cname="AV_FOURCC_MAX_STRING_SIZE",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
public const int AV_FOURCC_MAX_STRING_SIZE;

[CCode (cname="av_fourcc2str",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
...
***********************************************************/
[CCode (cname="av_fourcc_make_string",cheader_filename="subprojects/ffmpeg/libavutil/avutil.h")]
