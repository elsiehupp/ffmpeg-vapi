...
***********************************************************/
[CCode (cname="struct AVBSFList",cheader_filename="subprojects/ffmpeg/libavcodec/bsf.h")]
[Compact]
internal class BitStreamFilterList {
    ...
    ***********************************************************/
    [CCode (cname="av_bsf_list_alloc",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_bsf_list_free",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_bsf_list_append",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    @return >=0 on success, negative LibAVUtil.ErrorCode in case of failure
    ***********************************************************/
    [CCode (cname="av_bsf_list_append2",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    @return >=0 on success, negative LibAVUtil.ErrorCode in case of failure
    ***********************************************************/
    [CCode (cname="av_bsf_list_finalize",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
