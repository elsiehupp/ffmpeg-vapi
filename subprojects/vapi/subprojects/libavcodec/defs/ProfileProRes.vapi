...
public enum ProfileProRes {
    [CCode (cname="AV_PROFILE_PRORES_PROXY")]
    PROXY,

    [CCode (cname="AV_PROFILE_PRORES_LT")]
    LT,

    [CCode (cname="AV_PROFILE_PRORES_STANDARD")]
    STANDARD,

    [CCode (cname="AV_PROFILE_PRORES_HQ")]
    HQ,

    [CCode (cname="AV_PROFILE_PRORES_4444")]
    @4444,
...
public enum ProfileProResRaw {
    [CCode (cname="AV_PROFILE_PRORES_RAW")]
    RAW, // 0

    [CCode (cname="AV_PROFILE_PRORES_RAW_HQ")]
    RAW_HQ; // 1
}
