...
***********************************************************/
[CCode (cname="struct AVPacket",cheader_filename="subprojects/ffmpeg/libavcodec/packet.h")]
[Compact]
internal class LibAVCodec.Packet {
    /***********************************************************
    ...
    ***********************************************************/
    ...
    /***********************************************************
    @brief Presentation timestamp in LibAVFormat.Stream.time_base units; the time at which
    ...
    ***********************************************************/
    ...
    /***********************************************************
    @brief Decompression timestamp in LibAVFormat.Stream.time_base units; the time at which
    ...
    ***********************************************************/
    ...
    /***********************************************************
    @brief Duration of this packet in LibAVFormat.Stream.time_base units, 0 if unknown.
    ...
    ***********************************************************/
    [CCode (cname="av_packet_alloc",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    @see @link av_packet_ref
    ***********************************************************/
    [CCode (cname="av_packet_clone",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_packet_free",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    @param packet packet
    ***********************************************************/
    [CCode (cname="av_init_packet",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_new_packet",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    @param size new size
    ***********************************************************/
    [CCode (cname="av_shrink_packet",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_grow_packet",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_packet_from_data",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    ***********************************************************/
    ...
    @return a non-negative number on success, a negative LibAVUtil.ErrorCode code on
        ...
        owned by the caller.
    ***********************************************************/
    [CCode (cname="av_packet_add_side_data",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_packet_shrink_side_data",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    ***********************************************************/
    ...
    @param packet packet
    ***********************************************************/
    [CCode (cname="av_packet_free_side_data",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    @return 0 on success, a negative LibAVUtil.ErrorCode on error.
    ***********************************************************/
    [CCode (cname="av_packet_ref",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_packet_unref",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    @param output_packet Destination packet
    ***********************************************************/
    [CCode (cname="av_packet_move_ref",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_packet_copy_props",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    @return 0 on success, a negative LibAVUtil.ErrorCode on error. On failure, the
        packet is unchanged.
    ***********************************************************/
    [CCode (cname="av_packet_make_refcounted",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    @return 0 on success, a negative LibAVUtil.ErrorCode on failure. On failure, the
        packet is unchanged.
    ***********************************************************/
    [CCode (cname="av_packet_make_writable",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
    ...
    @param tb_dst output_packet timebase, to which the timing fields will be
        converted
    ***********************************************************/
    [CCode (cname="av_packet_rescale_ts",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
