...
[CCode (cname="av_file_map",cheader_filename="subprojects/ffmpeg/libavutil/file.h")]
...
/***********************************************************
@brief Unmap or free the buffer bufptr created by av_file_map ().

@param size size in bytes of bufptr, must be the same as returned
by av_file_map ()
***********************************************************/
[CCode (cname="av_file_unmap",cheader_filename="subprojects/ffmpeg/libavutil/file.h")]
...
/***********************************************************
@brief Wrapper to work around the lack of mkstemp () on mingw.
...
***********************************************************/
[CCode (cname="av_tempfile",cheader_filename="subprojects/ffmpeg/libavutil/file.h")]
