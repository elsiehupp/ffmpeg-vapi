...
/***********************************************************
@file An API-specific header for LibAVUtil.HardwareDeviceType.VDPAU.
...
***********************************************************/
[CCode (cname="struct AVVDPAUDeviceContext",cheader_filename="subprojects/ffmpeg/libavutil/hwcontext_vdpau.h")]
