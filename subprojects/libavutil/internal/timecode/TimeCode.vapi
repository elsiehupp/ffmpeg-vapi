...
[CCode (cname="struct AVTimecode",cheader_filename="subprojects/ffmpeg/libavutil/timecode.h")]
[Compact]
public class TimeCode {
    [CCode (cname="AV_TIMECODE_STR_SIZE",cheader_filename="subprojects/ffmpeg/libavutil/timecode.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_timecode_adjust_ntsc_framenum2",cheader_filename="subprojects/ffmpeg/libavutil/timecode.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_timecode_get_smpte_from_framenum",cheader_filename="subprojects/ffmpeg/libavutil/timecode.h")]
    ...
    @note The frame number is relative to tc.start.
    ***********************************************************/
    [CCode (cname="av_timecode_make_string",cheader_filename="subprojects/ffmpeg/libavutil/timecode.h")]
    ...
    @return the buffer parameter
    ***********************************************************/
    [CCode (cname="av_timecode_make_smpte_tc_string",cheader_filename="subprojects/ffmpeg/libavutil/timecode.h")]
    ...
    @return the buffer parameter
    ***********************************************************/
    [CCode (cname="av_timecode_make_mpeg_tc_string",cheader_filename="subprojects/ffmpeg/libavutil/timecode.h")]
    ...
    @param log_ctx a pointer to an arbitrary struct of which the first field
        is a pointer to an Class struct (used for LibAVUtil.Log.Class.av_log)
    ...
    ***********************************************************/
    [CCode (cname="av_timecode_init",cheader_filename="subprojects/ffmpeg/libavutil/timecode.h")]
    ...
    @param log_ctx a pointer to an arbitrary struct of which the first field is a
        pointer to an Class struct (used for LibAVUtil.Log.Class.av_log).
    @param tc pointer to an allocated TimeCode
    @param rate frame rate in rational form
    @param str timecode string which will determine the frame start
    @return 0 on success, LibAVUtil.ErrorCode otherwise
    ***********************************************************/
    [CCode (cname="av_timecode_init_from_string",cheader_filename="subprojects/ffmpeg/libavutil/timecode.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_timecode_check_frame_rate",cheader_filename="subprojects/ffmpeg/libavutil/timecode.h")]
