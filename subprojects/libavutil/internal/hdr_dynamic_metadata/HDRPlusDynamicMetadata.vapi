...
public class HDRPlusDynamicMetadata {
    ...
    ***********************************************************/
    [CCode (cname="itu_t_t35_country_code")]
    ...
    ***********************************************************/
    [CCode (cname="application_version")]
    ...
    ***********************************************************/
    [CCode (cname="targeted_system_display_maximum_luminance")]
    public LibAVUtil.Rational targeted_system_display_maximum_luminance;

    /***********************************************************
    @brief This flag shall be equal to 0 in bit streams conforming to this version
    of this Specification. The value 1 is reserved for future use.
    ***********************************************************/
    [CCode (cname="targeted_system_display_actual_peak_luminance_flag")]
    ...
    ***********************************************************/
    [CCode (cname="num_rows_targeted_system_display_actual_peak_luminance")]
    ...
    ***********************************************************/
    [CCode (cname="num_cols_targeted_system_display_actual_peak_luminance")]
    ...
    1/15.
    ***********************************************************/
    [CCode (cname="targeted_system_display_actual_peak_luminance")]
    public LibAVUtil.Rational targeted_system_display_actual_peak_luminance[25 * 25];
    ...
    ***********************************************************/
    [CCode (cname="mastering_display_actual_peak_luminance_flag")]
    ...
    ***********************************************************/
    [CCode (cname="num_rows_mastering_display_actual_peak_luminance")]
    ...
    array. The value shall be in the range of 2 to 25, inclusive.
    ***********************************************************/
    [CCode (cname="num_cols_mastering_display_actual_peak_luminance")]
    ...
    ***********************************************************/
    [CCode (cname="mastering_display_actual_peak_luminance")]
    public LibAVUtil.Rational mastering_display_actual_peak_luminance[25 * 25];
