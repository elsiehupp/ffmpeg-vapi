...
public abstract class Class {
    ...
    ***********************************************************/
    ...
    stderr. This behavior can be altered by setting a different logging callback
    function.
    @see LibAVUtil.Log.Class.av_log
    ...
    ***********************************************************/
    ...
    to eval as such a parent context, which an ::LibAVUtil.Log.Class.av_log () implementation
    ...
    ***********************************************************/
    [CCode (cname="state_flags_offset")]
