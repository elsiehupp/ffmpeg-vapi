...
private class TranscodeAACApplication : GLib.Application {
    ...
    ***********************************************************/
    private static int open_input_file (
        ...
        ***********************************************************/
        if (
            input_format_context_out.nb_streams != 1
        ) {
            fprintf (
                stderr,
    ...
    ***********************************************************/
    private static int open_output_file (
        ...
        ***********************************************************/
        output_format_context_out = avformat_alloc_context ();
        if (
        ...
        /***********************************************************
        Associate the output file (
            pointer) with the container format context.
        ***********************************************************/
        ...
        ***********************************************************/
        ...
        if (
            !output_format_context_out.oformat
        ) {
            fprintf (
                stderr,
        ...
        output_format_context_out.url = av_strdup (
            filename
        );

        if (
            !output_format_context_out.url
        ) {
            fprintf (
                stderr,
        ...
        ***********************************************************/
        ...
        Some container formats (
            like MP4) require global headers to be present.
        Mark the encoder so that it behaves accordingly.
        ***********************************************************/
        if (
            output_format_context_out.oformat.flags & LibAVFormat.FormatFlags1.WANTS_GLOBAL_HEADER)
            avctx.flags |= LibAVCodec.CodecFlags1.GLOBAL_HEADER;
    ...
    //  cleanup:
        ...
        avio_closep (
            ref output_format_context_out.pb
        );
    ...
    @return Error code (
        0 if successful)
    ***********************************************************/
    private static int init_packet (
        ref LibAVCodec.Packet? packet
    ) {
    ...
    @return Error code (
        0 if successful)
    ***********************************************************/
    private static int init_input_frame (
        ref LibAVFormat.Frame? frame
    ) {
        ...
        SwrContext? resample_context
            ...
            ***********************************************************/
            error = swr_alloc_set_opts2 (
                resample_context,
                ref output_codec_context.ch_layout,
                output_codec_context.sample_fmt,
                output_codec_context.sample_rate,
                ref input_codec_context.ch_layout,
    ...
    ***********************************************************/
    ...
    @return Error code (
        0 if successful)
    ***********************************************************/
    private static int write_output_file_header (
    ...
    ***********************************************************/
    private static int decode_audio_frame (
        ...
        ***********************************************************/
        LibAVCodec.Packet? input_packet;
        int error;
    ...
    ***********************************************************/
    private static int init_converted_samples (
        ...
        channels (
            although it may be null for interleaved formats).
    ...
    @return Error code (
        0 if successful)
    ***********************************************************/
    private static int convert_samples (
        uint8[]? input_data,
    ...
    @return Error code (
        0 if successful)
    ***********************************************************/
    private static int add_samples_to_fifo (
        AVAudioFifo? fifo,
    ...
    ***********************************************************/
    private static int read_decode_convert_and_store (
        ...
        ***********************************************************/
        LibAVFormat.Frame? input_frame = null;
        /***********************************************************
    ...
    ***********************************************************/
    private static int encode_audio_frame (
        ...
        Packet used for temporary storage.
        ***********************************************************/
        LibAVCodec.Packet? output_packet;
        int error;
    ...
    ***********************************************************/
    ...
    @return Error code (
        0 if successful)
    ***********************************************************/
    private static int write_output_file_trailer (
        LibAVFormat.FormatContext? output_format_context
    ) {
        int error = av_write_trailer (
        output_format_context
        );
    ...
    private static int main (
        ...
        ***********************************************************/
        if (
            open_input_file (
            argv[1],
            ref input_format_context,
            ref input_codec_context
        )
        ) {
            throw new Goto.CLEANUP (
                ""
        ...
        ***********************************************************/
        if (
            open_output_file (
                argv[2],
                input_codec_context,
                ref output_format_context,
                ref output_codec_context
            )
        ) {
            throw new Goto.CLEANUP (
                ""
