...
//      if (cle != CL_SUCCESS) {
//          LibAVUtil.Log.Class.av_log (avctx, LibAVUtil.Log.Level.ERROR, "Failed to set kernel "
//                 "argument %d: error %d.\n", arg_num, cle);
//          err = AVERROR (EIO);
//          goto fail;
//      }
...
//  {
//      if (cle != CL_SUCCESS) {
//          LibAVUtil.Log.Class.av_log (avctx, LibAVUtil.Log.Level.ERROR, __VA_ARGS__);
//          err = errcode;
//          goto fail;
//      }
//  }
...
//          if (cle != CL_SUCCESS)
//              LibAVUtil.Log.Class.av_log (avctx, LibAVUtil.Log.Level.ERROR, "Failed to release "
//                     "OpenCL kernel: %d.\n", cle);
//      }
//  }
