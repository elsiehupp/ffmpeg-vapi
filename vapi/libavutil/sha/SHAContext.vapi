...
[CCode (cname="struct AVSHA",cheader_filename="subprojects/ffmpeg/libavutil/sha.h")]
[Compact]
public class SHAContext {
    [CCode (cname="av_sha_size",cheader_filename="subprojects/ffmpeg/libavutil/sha.h")]
    public const size_t SIZE;

    /***********************************************************
    @brief Allocate an SHAContext context.
    ***********************************************************/
    [CCode (cname="av_sha_alloc",cheader_filename="subprojects/ffmpeg/libavutil/sha.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_sha_init",cheader_filename="subprojects/ffmpeg/libavutil/sha.h")]
    ...
    ***********************************************************/
    ...
    [CCode (cname="av_sha_update",cheader_filename="subprojects/ffmpeg/libavutil/sha.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_sha_final",cheader_filename="subprojects/ffmpeg/libavutil/sha.h")]
