...
public const int64 AV_NOPTS_VALUE; // ((int64_t)UINT64_C(0x8000000000000000))

/***********************************************************
Internal time base represented as integer
***********************************************************/

public const int64 AV_TIME_BASE; // 1000000

/***********************************************************
Internal time base represented as fractional value
***********************************************************/

public static LibAVUtil.Rational AV_TIME_BASE_Q; // AV_TIME_BASE_Q
//  #if __cplusplus
//  /* ISO C++ forbids compound-literals. */
//  av_make_q(1, AV_TIME_BASE)
//  #else
//  (LibAVUtil.Rational){1, AV_TIME_BASE}
//  #endif
...
***********************************************************/
public static inline void *av_x_if_null(const void *p, const void *x)
{
...
public const size_t AV_FOURCC_MAX_STRING_SIZE; // 32
