...
public class CodecContext {
    ...
    ***********************************************************/
    ...
    [Flags]
    [CCode (cprefix="FF_CODEC_PROPERTY_",cheader_filename="subprojects/ffmpeg/libavcodec/avcodec.h")]
...
public struct AVCodecContext {
    ...
    ***********************************************************/
    ...
    enum LibAVCodec.CodecID     codec_id; /* see AV_CODEC_ID_xxx */
...
#define FF_MB_DECISION_RD     2        ///< rate distortion
    ...
    ***********************************************************/
    ...
    - decoding: Set by libavcodec, user can override.
    ***********************************************************/
    int (*get_buffer2)(AVCodecContext *s, LibAVFormat.Frame *frame, int flags);
...
#define FF_SUB_CHARENC_MODE_IGNORE       2  ///< neither convert the subtitles, nor check them for valid UTF-8
    ...
    ***********************************************************/
    ...
    - decoding: unused
    ***********************************************************/
    int (*get_encode_buffer)(AVCodecContext *s, LibAVCodec.Packet *pkt, int flags);
...
***********************************************************/
int avcodec_receive_frame_flags (AVCodecContext *avctx, LibAVFormat.Frame *frame, unsigned flags);

/***********************************************************
Alias for `avcodec_receive_frame_flags (avctx, frame, 0)`.
***********************************************************/
int avcodec_receive_frame (AVCodecContext *avctx, LibAVFormat.Frame *frame);
...
***********************************************************/
int avcodec_send_frame (AVCodecContext *avctx, const LibAVFormat.Frame *frame);
...
@retval "another negative error code" legitimate encoding errors
***********************************************************/
int avcodec_receive_packet (AVCodecContext *avctx, LibAVCodec.Packet *avpkt);
