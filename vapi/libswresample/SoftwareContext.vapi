...
public class LibSoftwareResample.SoftwareContext {
    ...
    ***********************************************************/
    ...
    internal const int LIBSWRESAMPLE_VERSION_MAJOR; // 3

    [CCode (cname="",cheader_filename="subprojects/ffmpeg/libswresample/version.h")]
    internal const int LIBSWRESAMPLE_VERSION_MINOR; // 5

    [CCode (cname="",cheader_filename="subprojects/ffmpeg/libswresample/version.h")]
    internal const int LIBSWRESAMPLE_VERSION_MICRO; // 100

    [CCode (cname="",cheader_filename="subprojects/ffmpeg/libswresample/version.h")]
    internal const int LIBSWRESAMPLE_VERSION_INT;
    //  AV_VERSION_INT (
    ...
    [CCode (cname="",cheader_filename="subprojects/ffmpeg/libswresample/version.h")]
    internal const string LIBSWRESAMPLE_VERSION;
    //  AV_VERSION (
    //      LIBSWRESAMPLE_VERSION_MAJOR,
    //      LIBSWRESAMPLE_VERSION_MINOR,
    //      LIBSWRESAMPLE_VERSION_MICRO
    ...
    [CCode (cname="",cheader_filename="subprojects/ffmpeg/libswresample/version.h")]
    internal const int LIBSWRESAMPLE_BUILD; // LIBSWRESAMPLE_VERSION_INT

    [CCode (cname="",cheader_filename="subprojects/ffmpeg/libswresample/version.h")]
    internal const string LIBSWRESAMPLE_IDENT; // "SwR" AV_STRINGIFY (LIBSWRESAMPLE_VERSION)
