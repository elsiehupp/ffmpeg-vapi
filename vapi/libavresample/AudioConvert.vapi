...
[Compact]
internal class LibAVResample.AudioConvert {

    /***********************************************************
    Set conversion function if the parameters match.

    This compares the parameters of the conversion function to the parameters
    in the LibAVResample.AudioConvert context. If the parameters do not match, no changes are
    ...
    @param ac             LibAVResample.AudioConvert context
    ...
    ***********************************************************/
    ...
    /***********************************************************
    Allocate and initialize LibAVResample.AudioConvert context for sample format conversion.
    ...
    @return            newly-allocated LibAVResample.AudioConvert context
    ***********************************************************/
    [CCode (cname="",cheader_filename="subprojects/ffmpeg/libavresample/audio_convert.h")]
    ...
    /***********************************************************
    Free LibAVResample.AudioConvert.

    The LibAVResample.AudioConvert must have been previously allocated with ff_audio_convert_alloc ().

    @param ac  LibAVResample.AudioConvert struct
    ***********************************************************/
    [CCode (cname="",cheader_filename="subprojects/ffmpeg/libavresample/audio_convert.h")]
    ...
    For each call, the alignment of the input and output LibAVResample.AudioData buffers are
