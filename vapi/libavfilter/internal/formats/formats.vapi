...
***********************************************************/
[CCode (cname="struct LibAVFilter.FilterFormats",cheader_filename="subprojects/ffmpeg/libavfilter/formats.h")]
[Compact]
public class LibAVFilter.FilterFormats {
    /***********************************************************
    number of formats
    ***********************************************************/
    [CCode (cname="")]
    ...
    ***********************************************************/
    [CCode (cname="")]
    public LibAVFilter.FilterFormats[][] refs;
}

/***********************************************************
A list of supported channel layouts.

The list works the same as LibAVFilter.FilterFormats, except for the following
differences:
...
***********************************************************/
[CCode (cname="struct LibAVFilter.FilterChannelLayouts",cheader_filename="subprojects/ffmpeg/libavfilter/formats.h")]
[Compact]
public class LibAVFilter.FilterChannelLayouts {
    /***********************************************************
    ...
    ***********************************************************/
    [CCode (cname="")]
    public LibAVFilter.FilterChannelLayouts[][] refs;
}
...
The result is only valid inside LibAVFilter.FilterChannelLayouts and immediately
related functions.
***********************************************************/
...
//  {
//      return (0x8000000000000000ULL | (c));
//  }
...
***********************************************************/
[CCode (cname="",cheader_filename="subprojects/ffmpeg/libavfilter/formats.h")]
public LibAVFilter.FilterChannelLayouts ff_merge_channel_layouts (
    LibAVFilter.FilterChannelLayouts? a,
    LibAVFilter.FilterChannelLayouts? b
);

[CCode (cname="",cheader_filename="subprojects/ffmpeg/libavfilter/formats.h")]
public LibAVFilter.FilterFormats ff_merge_samplerates (
    LibAVFilter.FilterFormats? a,
    LibAVFilter.FilterFormats? b
);

/***********************************************************
Construct an empty LibAVFilter.FilterChannelLayouts/LibAVFilter.FilterFormats struct --
representing any channel layout (with known disposition)/sample rate.
***********************************************************/
[CCode (cname="",cheader_filename="subprojects/ffmpeg/libavfilter/formats.h")]
//  av_warn_unused_result
public LibAVFilter.FilterChannelLayouts ff_all_channel_layouts ();

[CCode (cname="",cheader_filename="subprojects/ffmpeg/libavfilter/formats.h")]
//  av_warn_unused_result
public LibAVFilter.FilterFormats ff_all_samplerates ();

/***********************************************************
Construct an LibAVFilter.FilterChannelLayouts coding for any channel layout, with
known or unknown disposition.
***********************************************************/
[CCode (cname="",cheader_filename="subprojects/ffmpeg/libavfilter/formats.h")]
//  av_warn_unused_result
public LibAVFilter.FilterChannelLayouts ff_all_channel_counts ();

[CCode (cname="",cheader_filename="subprojects/ffmpeg/libavfilter/formats.h")]
//  av_warn_unused_result
public LibAVFilter.FilterChannelLayouts avfilter_make_format64_list (
    const int64[] fmts
);

[CCode (cname="",cheader_filename="subprojects/ffmpeg/libavfilter/formats.h")]
//  av_warn_unused_result
public LibAVFilter.FilterChannelLayouts ff_make_formatu64_list (
    const uint64[] fmts
);
...
public int ff_set_common_channel_layouts (
    ...
    LibAVFilter.FilterChannelLayouts? layouts
);
...
public int ff_set_common_samplerates (
    LibAVFilter.FilterContext? av_filter_context,
    LibAVFilter.FilterFormats? samplerates
);
...
public int ff_set_common_formats (
    LibAVFilter.FilterContext? av_filter_context,
    LibAVFilter.FilterFormats? formats
);

[CCode (cname="",cheader_filename="subprojects/ffmpeg/libavfilter/formats.h")]
//  av_warn_unused_result
public int ff_add_channel_layout (
    LibAVFilter.FilterChannelLayouts **l,
...
public int ff_channel_layouts_ref (
    LibAVFilter.FilterChannelLayouts? f,
    LibAVFilter.FilterChannelLayouts **ref
);
...
public void ff_channel_layouts_changeref (
    LibAVFilter.FilterChannelLayouts **oldref,
    LibAVFilter.FilterChannelLayouts **newref
);
...
LibAVFilter.Filter->query_formats ().
...
[CCode (cname="",cheader_filename="subprojects/ffmpeg/libavfilter/formats.h")]
//  av_warn_unused_result
public LibAVFilter.FilterFormats ff_make_format_list (
    int[] fmts
);
...
public int ff_add_format (
    LibAVFilter.FilterFormats **avff,
    int64 fmt
);
...
[CCode (cname="",cheader_filename="subprojects/ffmpeg/libavfilter/formats.h")]
//  av_warn_unused_result
public LibAVFilter.FilterFormats ff_all_formats (
...
[CCode (cname="",cheader_filename="subprojects/ffmpeg/libavfilter/formats.h")]
//  av_warn_unused_result
public LibAVFilter.FilterFormats ff_planar_sample_fmts ();
...
***********************************************************/
[CCode (cname="",cheader_filename="subprojects/ffmpeg/libavfilter/formats.h")]
public LibAVFilter.FilterFormats ff_merge_formats (
    LibAVFilter.FilterFormats? a,
    LibAVFilter.FilterFormats? b,
    LibAVUtil.MediaType type
);
...
reference, and sets? ref to NULL.
 ...
 | |refs| |    |  __|_                  | |refs| |    |  __|_
 | |* * | |    | |  | |  LibAVFilter.FilterLink   | |* * | |    | |  | |  LibAVFilter.FilterLink
 | |* *--------->|*ref|                 | |*   | |    | |*ref|
 | |____| |    | |____|                 | |____| |    | |____|
...
public void ff_formats_changeref (
    LibAVFilter.FilterFormats **oldref,
    LibAVFilter.FilterFormats **newref
);
