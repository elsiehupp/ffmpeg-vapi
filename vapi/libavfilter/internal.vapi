...
int ff_parse_pixel_format (AVPixelFormat *ret, string arg, void *log_ctx);
...
***********************************************************/
av_warn_unused_result
int ff_parse_sample_rate (int *ret, string arg, void *log_ctx);
...
***********************************************************/
av_warn_unused_result
int ff_parse_time_base (AVRational *ret, string arg, void *log_ctx);
...
***********************************************************/
av_warn_unused_result
int ff_parse_sample_format (int *ret, string arg, void *log_ctx);
...
***********************************************************/
av_warn_unused_result
int ff_parse_channel_layout (int64 *ret, int *nret, string arg,
                            void *log_ctx);

void ff_update_link_current_pts (AVFilterLink *link, int64 pts);
...
***********************************************************/
void ff_avfilter_link_set_in_status (AVFilterLink *link, int status, int64 pts);

/***********************************************************
Set the status field of a link from the destination filter.
The pts should probably be left unset (AV_NOPTS_VALUE).
***********************************************************/
void ff_avfilter_link_set_out_status (AVFilterLink *link, int status, int64 pts);
...
string ff_get_ref_perms_string (string buf, size_t buf_size, int perms);
...
***********************************************************/
AVFilterContext *ff_filter_alloc (const AVFilter *filter, string inst_name);
