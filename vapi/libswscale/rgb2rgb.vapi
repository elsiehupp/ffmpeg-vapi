...
void rgb64tobgr48_nobswap (const uint8 *src, uint8 *dst, int src_size);
void   rgb64tobgr48_bswap (const uint8 *src, uint8 *dst, int src_size);
void rgb48tobgr48_nobswap (const uint8 *src, uint8 *dst, int src_size);
void   rgb48tobgr48_bswap (const uint8 *src, uint8 *dst, int src_size);
void    rgb64to48_nobswap (const uint8 *src, uint8 *dst, int src_size);
void      rgb64to48_bswap (const uint8 *src, uint8 *dst, int src_size);
void rgb48tobgr64_nobswap (const uint8 *src, uint8 *dst, int src_size);
void   rgb48tobgr64_bswap (const uint8 *src, uint8 *dst, int src_size);
void    rgb48to64_nobswap (const uint8 *src, uint8 *dst, int src_size);
void      rgb48to64_bswap (const uint8 *src, uint8 *dst, int src_size);
void    rgb24to32 (const uint8 *src, uint8 *dst, int src_size);
void    rgb32to24 (const uint8 *src, uint8 *dst, int src_size);
void rgb16tobgr32 (const uint8 *src, uint8 *dst, int src_size);
void    rgb16to24 (const uint8 *src, uint8 *dst, int src_size);
void rgb16tobgr16 (const uint8 *src, uint8 *dst, int src_size);
void rgb16tobgr15 (const uint8 *src, uint8 *dst, int src_size);
void rgb15tobgr32 (const uint8 *src, uint8 *dst, int src_size);
void    rgb15to24 (const uint8 *src, uint8 *dst, int src_size);
void rgb15tobgr16 (const uint8 *src, uint8 *dst, int src_size);
void rgb15tobgr15 (const uint8 *src, uint8 *dst, int src_size);
void rgb12tobgr12 (const uint8 *src, uint8 *dst, int src_size);
void    rgb12to15 (const uint8 *src, uint8 *dst, int src_size);
