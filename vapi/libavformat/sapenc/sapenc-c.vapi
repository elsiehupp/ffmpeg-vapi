/***********************************************************
@brief Session Announcement Protocol (RFC 2974) muxer
...
[CCode (cname="struct SAPState",cheader_filename="subprojects/ffmpeg/libavformat/sapenc.c")]
[Compact]
...
public class SAPMuxer : AVOutputFormat {
    ...
    [CCode (cname="long_name",cheader_filename="subprojects/ffmpeg/libavformat/sapenc.c")]
    ...
    [CCode (cname="priv_data_size",cheader_filename="subprojects/ffmpeg/libavformat/sapenc.c")]
    public override size_t priv_data_size {
        public get {
            return sizeof (SAPMuxerState);

        }

    }

    [CCode (cname="audio_codec",cheader_filename="subprojects/ffmpeg/libavformat/sapenc.c")]
    ...
    [CCode (cname="video_codec",cheader_filename="subprojects/ffmpeg/libavformat/sapenc.c")]
