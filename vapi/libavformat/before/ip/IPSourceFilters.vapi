...
***********************************************************/
[CCode (cname="struct IPSourceFilters",cheader_filename="subprojects/ffmpeg/libavformat/ip.h")]
[Compact]
public class IPSourceFilters {
    ...
    [CCode (cname="")]
    public sockaddr_storage include_addrs;

    [CCode (cname="")]
    public sockaddr_storage exclude_addrs;
}
...
@return 0 if packet should be processed based on the filter, 1 if the packet
    can be dropped.
***********************************************************/
[CCode (cname="",cheader_filename="subprojects/ffmpeg/libavformat/ip.h")]
