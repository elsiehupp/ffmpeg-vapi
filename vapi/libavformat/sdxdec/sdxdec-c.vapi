...
public class SDXDemuxer : AVInputFormat {
    ...
    [CCode (cname="long_name",cheader_filename="subprojects/ffmpeg/libavformat/sdxdec.c")]
    public override string long_name {
        public get {
            return "Sample Dump eXchange";
    ...
    [CCode (cname="extensions",cheader_filename="subprojects/ffmpeg/libavformat/sdxdec.c")]
    ...
    [CCode (cname="flags",cheader_filename="subprojects/ffmpeg/libavformat/sdxdec.c")]
