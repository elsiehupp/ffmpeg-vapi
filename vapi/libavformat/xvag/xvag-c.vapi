...
public class XVAGDemuxer : AVInputFormat {
    ...
    [CCode (cname="long_name",cheader_filename="subprojects/ffmpeg/libavformat/xvag.c")]
    ...
    [CCode (cname="extensions",cheader_filename="subprojects/ffmpeg/libavformat/xvag.c")]
