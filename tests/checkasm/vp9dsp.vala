                ...
                ***********************************************************/
                for (
                    ...
                    if (
                        ...
                        call_ref (
                            dst0,
                            sz * SIZEOF_PIXEL, subcoef0, eob
                        );

                        call_new (
                            dst1,
                            sz * SIZEOF_PIXEL, subcoef1, eob
                        );

                        if (
                            memcmp (
                                dst0,
                            dst1, sz * sz * SIZEOF_PIXEL
                            ) ||
                            !iszero (
                                subcoef0,
                            sz * sz * SIZEOF_COEF
            ...
            for (
                ...
                ***********************************************************/
                if (
                    ...
                    call_ref (
                        buf0,
                        16 * SIZEOF_PIXEL >> dir, E[0], I[0], H[0]
                    );
