...
const string pred4x4_modes[4][15] = {
    {
        /***********************************************************
        H.264
        ***********************************************************/
...
const string pred8x8_modes[4][11] = {
    {
        /***********************************************************
        H.264
        ***********************************************************/
...
const string pred16x16_modes[4][9] = {
    {
        /***********************************************************
        H.264
        ***********************************************************/
...
const size_t BUF_SIZE = (3 * 16 * 17);

void check_pred_func (func, name, mode_name) {
...
static void check_pred4x4 (
    ...
    if (chroma_format == 1) {
        ...
        int pred_mode;
        declare_func_emms (AV_CPU_FLAG_MMX | AV_CPU_FLAG_MMXEXT, void, uint8[] src, uint8[] topright, size_t stride);
