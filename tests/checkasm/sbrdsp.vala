...
private static void test_sum64x5 () {
...
private static void test_sum_square () {
    INTFLOAT res0;
    INTFLOAT res1;
...
private static void test_neg_odd_64 () {
...
private static void test_qmf_pre_shuffle () {
...
private static void test_qmf_deint_neg () {
    //  LOCAL_ALIGNED_16 (INTFLOAT, src, [64]);
    //  LOCAL_ALIGNED_16 (INTFLOAT, dst0, [64]);
    //  LOCAL_ALIGNED_16 (INTFLOAT, dst1, [64]);

    //  declare_func (void, INTFLOAT *v, INTFLOAT *src);
...
private static void test_qmf_deint_bfly () {
    //  LOCAL_ALIGNED_16 (INTFLOAT, src0, [64]);
    //  LOCAL_ALIGNED_16 (INTFLOAT, src1, [64]);
    //  LOCAL_ALIGNED_16 (INTFLOAT, dst0, [128]);
    //  LOCAL_ALIGNED_16 (INTFLOAT, dst1, [128]);

    //  declare_func (void, INTFLOAT *v, INTFLOAT *src0, INTFLOAT *src1);
...
private static void test_hf_gen () {
    ...
    //  declare_func (void, INTFLOAT (*X_high)[2], INTFLOAT (*X_low)[2],
...
private static void test_hf_g_filt () {
    //  LOCAL_ALIGNED_16 (INTFLOAT, high, [128], [40][2]);
    //  LOCAL_ALIGNED_16 (INTFLOAT, g_filt, [128]);
    //  LOCAL_ALIGNED_16 (INTFLOAT, dst0, [128], [2]);
    //  LOCAL_ALIGNED_16 (INTFLOAT, dst1, [128], [2]);

    //  declare_func (void, INTFLOAT (*Y)[2], INTFLOAT (*X_high)[40][2],
    //                     INTFLOAT *g_filt, int m_max, intptr_t ixh);
...
private static void test_hf_apply_noise (SBRDSPContext *sbrdsp) {
    ...
    //  declare_func (void, INTFLOAT (*Y)[2], AAC_FLOAT *s_m,
    //                     AAC_FLOAT *q_filt, int noise,
    //                     int kx, int m_max);
...
private static void checkasm_check_sbrdsp () {
