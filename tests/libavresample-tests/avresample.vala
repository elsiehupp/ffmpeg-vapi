...
public static double dbl_rand (AVLFG *lfg
) {
    return 2.0 * (av_lfg_get (lfg) / (double)UINT_MAX) - 1.0;
}

#define PUT_FUNC (name, fmt, type, expr)                                     \
public static void put_sample_ ## name (void **data, enum AVSampleFormat sample_fmt,\
...
public static void put_sample (void **data, enum AVSampleFormat sample_fmt,
...
public static void audiogen (AVLFG *rnd, void **data, enum AVSampleFormat sample_fmt,
