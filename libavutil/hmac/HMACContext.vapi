...
[CCode (cname="struct AVHMAC", cheader_filename="libavcodec/hmac.h")]
public struct HMACContext {
    ...
    ***********************************************************/
    [CCode (cname="av_hmac_alloc", cheader_filename="libavcodec/hmac.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_hmac_free", cheader_filename="libavcodec/hmac.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_hmac_init", cheader_filename="libavcodec/hmac.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_hmac_update", cheader_filename="libavcodec/hmac.h")]
    ...
    ***********************************************************/
    [CCode (cname="av_hmac_final", cheader_filename="libavcodec/hmac.h")]
    ...
    @return The number of bytes written to output_buffer, or a negative error code.
    ***********************************************************/
    [CCode (cname="av_hmac_calc", cheader_filename="libavcodec/hmac.h")]
