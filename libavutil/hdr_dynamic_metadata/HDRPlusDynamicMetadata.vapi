...
the public ABI.
***********************************************************/
[CCode (cname="struct AVDynamicHDRPlus", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
public struct HDRPlusDynamicMetadata {
    /***********************************************************
    @brief Country code by Rec. ITU-T T.35 Annex A. The value shall be 0xB5.
    ***********************************************************/
    [CCode (cname="itu_t_t35_country_code", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
    ...
    ***********************************************************/
    [CCode (cname="application_version", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
    ...
    of 1 to 3, inclusive.
    ***********************************************************/
    [CCode (cname="num_windows", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
    public uint8 num_windows;

    /***********************************************************
    @brief The color transform parameters for every processing window.
    ***********************************************************/
    [CCode (cname="params", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
    ...
    ***********************************************************/
    [CCode (cname="targeted_system_display_maximum_luminance", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
    ...
    ***********************************************************/
    [CCode (cname="targeted_system_display_actual_peak_luminance_flag", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
    ...
    ***********************************************************/
    [CCode (cname="num_rows_targeted_system_display_actual_peak_luminance", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
    ...
    ***********************************************************/
    [CCode (cname="num_cols_targeted_system_display_actual_peak_luminance", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
    ...
    1/15.
    ***********************************************************/
    [CCode (cname="targeted_system_display_actual_peak_luminance", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
    ...
    ***********************************************************/
    [CCode (cname="mastering_display_actual_peak_luminance_flag", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
    ...
    ***********************************************************/
    [CCode (cname="num_rows_mastering_display_actual_peak_luminance", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
    ...
    array. The value shall be in the range of 2 to 25, inclusive.
    ***********************************************************/
    [CCode (cname="num_cols_mastering_display_actual_peak_luminance", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
    ...
    ***********************************************************/
    [CCode (cname="mastering_display_actual_peak_luminance", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
    ...
    @return An HDRPlusDynamicMetadata filled with default values or null
        on failure.
    ***********************************************************/
    [CCode (cname="av_dynamic_hdr_plus_alloc", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
    ...
    @return The HDRPlusDynamicMetadata structure to be filled by caller or null
        on failure.
    ***********************************************************/
    [CCode (cname="av_dynamic_hdr_plus_create_side_data", cheader_filename="libavcodec/hdr_dynamic_metadata.h")]
